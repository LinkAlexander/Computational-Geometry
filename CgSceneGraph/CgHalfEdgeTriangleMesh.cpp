    ...
    std::vector<unsigned int> temp_indices)
{
    ...
    for (std::size_t i = 0; i < temp_indices.size(); i += 3) {
        ...
        // indices
        unsigned vert_index_1 = temp_indices[i];
        unsigned vert_index_2 = temp_indices[i + 1];
        unsigned vert_index_3 = temp_indices[i + 2];

        // vertices of a triangle
        CgHeVert* vert1 = (CgHeVert*)m_verts[vert_index_1];
        CgHeVert* vert2 = (CgHeVert*)m_verts[vert_index_2];
        CgHeVert* vert3 = (CgHeVert*)m_verts[vert_index_3];
        ...
        edges_by_vertices[std::make_pair(vert_index_2, vert_index_3)] = edge2;
        edges_by_vertices[std::make_pair(vert_index_3, vert_index_1)] = edge3;
        ...
        CgHeEdge* pair2 = edges_by_vertices[std::make_pair(vert_index_3, vert_index_2)];
        CgHeEdge* pair3 = edges_by_vertices[std::make_pair(vert_index_1, vert_index_3)];
...
/**
 * @brief CgHalfEdgeTriangleMesh::loopSubdevision Performs the loop subdevision.
 */
